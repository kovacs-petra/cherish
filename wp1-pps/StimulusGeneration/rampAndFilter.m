...
frequency = 700;
    ...
    elseif trajectory >= 3 % rotating near or far
        ...
        azi = [linspace(0.1, 0.1, round(durStatOnset*fs)), ...
            linspace(0.1, offsetAzimuth-0.1, round(durMoving*fs)), ...
            linspace(offsetAzimuth-0.1, offsetAzimuth-0.1, round(durStatOffset*fs))];        
    end
